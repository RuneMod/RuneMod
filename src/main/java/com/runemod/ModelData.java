...
import com.runemod.cache.models.FaceNormal;
import com.runemod.cache.models.VertexNormal;
...
public class ModelData {
    ...
    public static ModelData load(int modelId, byte[] b)
    {
    ...
    static void decodeType3(ModelData def, byte[] var1)
    {
    ...
    static void decodeType2(ModelData def, byte[] var1)
    {
        boolean var2 = false;
        boolean var3 = false;
        Buffer var4 = new Buffer(var1);
    ...
    static void decodeType1(ModelData def, byte[] var1)
    {
        Buffer var2 = new Buffer(var1);
        Buffer var3 = new Buffer(var1);
        Buffer var4 = new Buffer(var1);
    ...
    static void decodeOldFormat(ModelData def, byte[] inputData)
    {
        boolean usesFaceRenderTypes = false;
        boolean usesFaceTextures = false;
        Buffer stream1 = new Buffer(inputData);
        Buffer stream2 = new Buffer(inputData);
        Buffer stream3 = new Buffer(inputData);
        Buffer stream4 = new Buffer(inputData);
        Buffer stream5 = new Buffer(inputData);
